...
rem #
rem #  Pre-requisite: the_conf must point to an existing configuration file. At
rem #                 NRC we use win-static.conf but the user can use an arbitrary name.
rem #
rem #  BEWARE: Change variable QTDIR below to point to the desired Qt library. The current
...
rem #          static version.
rem #
rem #  NOTE: If QTDIR is set to the desired Qt library version in the user's environment,
rem #        one comment out the line below that sets QTDIR.
rem #
rem ###############################################################################
