...
###############################################################################
#
# Initially, the whole system was distributed in several unix tar-files
# (compressed and uncompressed).
#
# Since the system is now downloaded or cloned from github, this tool is currently
# used to build pre-compiled Qt GUIs, statically linked to the Qt library.
# The compressed tar-file is also appended to the egs_configure tool which properly
# deploys the files in an EGSnrc system.
#
# Note that one could use this tool to create a compressed archive with arbitrary
# files using the same format as in file egs_guis_list
#
###############################################################################
*/
